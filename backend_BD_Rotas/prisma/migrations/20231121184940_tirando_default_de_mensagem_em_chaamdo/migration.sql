...
INSERT INTO "new_Chamado" ("dataAberturaChamado", "descChamado", "id", "idAndamento", "idCategoria", "idComputador", "idLab", "idPrioridade", "idSuporte", "idUsuario", "mensagem", "nomeChamado", "tratFim", "tratInicio") SELECT "dataAberturaChamado", "descChamado", "id", "idAndamento", "idCategoria", "idComputador", "idLab", "idPrioridade", "idSuporte", "idUsuario", "mensagem", "nomeChamado", "tratFim", "tratInicio" FROM "Chamado";
DROP TABLE "Chamado";
